...
class TowerDefenseEnv(gym.Env):
    ...
    def place_tower(self):
        ...
        self.move_cursor_to_random_adjacent()
        # print("[ENV DEBUG] Tower placed at:", pos)
