...
class TowerDefenseEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.enemy_info = {
            ...
            0: {'color': (0, 128, 128), 'health': 10, 'damage': 5, 'range': 1},
            # 1: {'color': (128, 0, 0), 'health': 20, 'damage': 2, 'range': 2}
            1: {'color': (128, 0, 0), 'health': 20, 'damage': 5, 'range': 2}
        }
    ...
    def update_enemies(self):
        ...
        if self.enemy_count < self.max_enemies:
            ...
            for enemy in self.enemies:
                ...
                enemy['x'] -= 1
            self.enemies.append(
                {'x': self.cols, 'type': enemy_type - 1, 'health': self.enemy_info[enemy_type - 1]['health'],
